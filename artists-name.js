    ...
    try {
        ...
        if (data.success) {
            ...
            songs.forEach((song) => {
               ...
               songId  = song.id;
               navigateToEachArtist(songId,artistName);
...
const navigateToEachArtist = (songId,artName) => {
    console.log(songId,artName);
    window.location.href = `./SongsPlayer.html?songId=${songId}&artName=${artName}`;
};
